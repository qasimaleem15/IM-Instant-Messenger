...
const drawerstyle = {
  ...
  "@media (max-width: 600px)": {
    // Media query for mobile screens (example: max-width 600px)
...
const ScreenShareInfoDrawer = ({ open, setOpen }) => {
    ...
    >
      <Header>
        <ArrowBack
          ...
          className="cursor_pointer drawer_arrow"
        />
        <Typography>Screen Share</Typography>
      </Header>
      <Component>
        <Profile />
      </Component>
...
export default ScreenShareInfoDrawer;
